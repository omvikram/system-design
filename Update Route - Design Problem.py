...
# How to notify other customers
# How to suggest the alternate route
# How to scale the Notification queue if there are 50K incidents happen in a worst case scenario?
